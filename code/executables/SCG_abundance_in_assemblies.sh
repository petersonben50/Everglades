...
#########################
# Dereplicate SCGs across assemblies
#########################
cat *_$geneName\_*.faa > $geneName\_raw.faa
...
do
  ...
  echo "Calculating coverage of each reside in a" $geneName"+ scaffold in" $metagenome
  ...
  echo -e "$geneName\t$metagenome\t$coverage_count" >> /home/GLBRCORG/bpeterson26/Everglades/dataEdited/2019_analysis_assembly/scg_abundance/$geneName\_scg_coverage.tsv
