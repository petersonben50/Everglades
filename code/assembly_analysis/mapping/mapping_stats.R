#### code/assembly_analysis/mapping/mapping_stats.R ####
# Benjamin D. Peterson
...
uniq.mapped.reads <- read.table("dataEdited/assembly_analysis/reports/uniq_mapped_reads_MG.tsv",
                                sep = "\t",
...
#### Save out data ####
write.csv(all.data,
          "results/metagenomes/housekeeping/mapping_stats.csv",
          row.names = FALSE)
