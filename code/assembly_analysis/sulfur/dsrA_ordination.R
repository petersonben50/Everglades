...
dsrA.phyloseq <- otu_table(evenness.data,
                           taxa_are_rows = FALSE)

# Calculate Shannon diversity
diversity.vector <- diversity(dsrA.phyloseq,
                              index = "shannon")
...
all.phyloseq <- merge_phyloseq(dsrA.phyloseq, meta.phylo)


#### Generate ordination ####
dsrA.bray <- ordinate(all.phyloseq,
                      method = "PCoA",
                      distance = "bray")

bc.ord.dsrA <- plot_ordination(all.phyloseq,
                               dsrA.bray,
                               color = "siteID",
                               shape = "siteID") +
...
#### Save out ordination ####
saveRDS(bc.ord.dsrA,
        "results/metagenomes/assembly/SRB/dsrA_ordination.rds")
