...
mkdir sulfur
mkdir sulfur/dsr
mkdir sulfur/dsr/dsrA_phylogeny_red_vs_reverse

# Copy over my sequences
cp derep/dsrA.afa sulfur/dsr/dsrA_phylogeny_red_vs_reverse/dsrA.afa
# Copy in reference sequences
cd ~/Everglades/dataEdited/2018_analysis_assembly/metabolicProteins/sulfur/dsr/dsrA_phylogeny_red_vs_reverse/
...
PYTHONPATH=""
PERL5LIB=''
cd ~/Everglades/dataEdited/2018_analysis_assembly/metabolicProteins/sulfur/dsr
...
do
  grep -A 1 -m 1 $dsrA dsrA_phylogeny_red_vs_reverse/dsrA.afa >> dsrA_reductive_phylogeny/dsrA.afa
done
...
# On local computer
Everglades
cd dataEdited/2018_analysis_assembly/metabolicProteins/sulfur/dsr/dsrA_reductive_phylogeny/
