...
#### Read in reference data for McDaniel 2020 ####
...
hgcA.references.nr <- read.table("references/hgcA/2019_assembly_analysis/hgcA_ref_nr_taxonomy.tsv",
                                 stringsAsFactors = FALSE,
                                 sep = '\t') %>%
...
# Visualize tree
pdf("results/2019_analysis_assembly/hgcA_tree_RAxML_midpointRooting.pdf",
    height = 30,
    width = 10)
ggtree(hgcA.tree, aes(x = 0,
                      xend = 4.5)) + 
